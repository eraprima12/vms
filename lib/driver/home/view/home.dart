                          ...
                          children: [
                                ...
                                children: [
                                  Expanded(
                                    child: WidgetText(
                                      ...
                                      text: 'Hi, ${provider.userDriver!.name}',
                                    ),
                                  ),
                                  GestureDetector(
                                    onTap: () {
                              ...
                              children: [
                                Expanded(
                                  child: CardWithTotalDistance(
                                    ...
                                    data: WidgetText(
                                      color: Colors.white,
                                      text: provider.userDriver!.distanceToday
                                          .toStringAsFixed(2),
                                      fontSize: 24,
                                      fontWeight: FontWeight.w700,
                                    ),
                                ...
                                Expanded(
                                  child: CardWithTotalDistance(
                                    ...
                                    data: WidgetText(
                                      color: Colors.white,
                                      text: provider.userDriver!.totalDistance
                                          .toStringAsFixed(2),
                                      fontSize: 24,
                                      fontWeight: FontWeight.w700,
                                    ),
                            ...
                            CardWithServiceInKm(
                              ...
                              data: const WidgetText(
                                color: Colors.white,
                                text: '500', // Replace with your data
                                fontSize: 24,
                                fontWeight: FontWeight.w700,
                              ),
                            ),
                            ...
                            CardWithTitleAndSubtitle(
                              data: Column(
                                ...
                                children: [
                                  ...
                                  WidgetText(
                                    text:
                                        '${provider.userDriver!.latestPosition.latitude}, ${provider.userDriver!.latestPosition.longitude}',
                                    color: Colors.white,
